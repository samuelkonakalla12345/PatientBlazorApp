        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProgressNotes_Visits_VisitId",
                        column: x => x.VisitId,
                        principalTable: "Visits",
                        principalColumn: "VisitId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgressNotes_Visits_VisitId1",
                        column: x => x.VisitId1,
                        principalTable: "Visits",
                        principalColumn: "VisitId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_FirstName_MobileNumber_OrganizationId",
                table: "Patients",
                columns: new[] { "FirstName", "MobileNumber", "OrganizationId" });

            migrationBuilder.CreateIndex(
                name: "IX_ProgressNotes_VisitId",
                table: "ProgressNotes",
                column: "VisitId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressNotes_VisitId1",
                table: "ProgressNotes",
                column: "VisitId1");
